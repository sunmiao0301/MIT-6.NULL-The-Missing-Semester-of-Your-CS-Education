...
- [学习操作系统相关内容的推荐，比如进程，虚拟内存，中断，内存管理等](https://missing-semester-cn.github.io/2020/qa/#学习操作系统相关内容的推荐比如进程虚拟内存中断内存管理等)
- [你会优先学习的工具有那些?](https://missing-semester-cn.github.io/2020/qa/#你会优先学习的工具有那些)
- [使用 Python VS Bash脚本 VS 其他语言?](https://missing-semester-cn.github.io/2020/qa/#使用-python-vs-bash脚本-vs-其他语言)
- [`source script.sh` 和 `./script.sh` 有什么区别？](https://missing-semester-cn.github.io/2020/qa/#source-scriptsh-和-scriptsh-有什么区别)
- [各种软件包和工具存储在哪里？引用过程是怎样的? `/bin` 或 `/lib` 是什么？](https://missing-semester-cn.github.io/2020/qa/#各种软件包和工具存储在哪里引用过程是怎样的-bin-或-lib-是什么)
- [我应该用 `apt-get install` 还是 `pip install` 去下载软件包呢?](https://missing-semester-cn.github.io/2020/qa/#我应该用-apt-get-install-还是-pip-install-去下载软件包呢)
- [用于提高代码性能，简单好用的性能分析工具有哪些?](https://missing-semester-cn.github.io/2020/qa/#用于提高代码性能简单好用的性能分析工具有哪些)
- [你使用那些浏览器插件?](https://missing-semester-cn.github.io/2020/qa/#你使用那些浏览器插件)
- [有哪些有用的数据整理工具？](https://missing-semester-cn.github.io/2020/qa/#有哪些有用的数据整理工具)
- [Docker和虚拟机有什么区别?](https://missing-semester-cn.github.io/2020/qa/#Docker和虚拟机有什么区别)
- [不同操作系统的优缺点是什么，我们如何选择（比如选择最适用于我们需求的Linux发行版）？](https://missing-semester-cn.github.io/2020/qa/#不同操作系统的优缺点是什么我们如何选择比如选择最适用于我们需求的Linux发行版)
- [使用 Vim 编辑器 VS Emacs 编辑器?](https://missing-semester-cn.github.io/2020/qa/#使用-vim-编辑器-vs-emacs-编辑器)
- [机器学习应用的提示或技巧?](https://missing-semester-cn.github.io/2020/qa/#机器学习应用的提示或技巧)
- [还有更多的 Vim 小窍门吗？](https://missing-semester-cn.github.io/2020/qa/#还有更多的-vim-小窍门吗)
- [2FA是什么，为什么我需要使用它?](https://missing-semester-cn.github.io/2020/qa/#2FA是什么为什么我需要使用它)
- [对于不同的 Web 浏览器有什么评价?](https://missing-semester-cn.github.io/2020/qa/#对于不同的-Web-浏览器有什么评价)
